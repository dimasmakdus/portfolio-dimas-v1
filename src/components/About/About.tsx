    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={400}>
          <div className="education">
            <h3>Education:</h3>
            <h4>Universitas Komputer Indonesia (UNIKOM)</h4>
            <p>Bachelor's degree, Computer Engineering, Kota Bandung | September 2015 - February 2020</p>
          </div>
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInLeft" delay={550}>
          <div className="experience">
             <h3>Experience:</h3><h4>Full Stack Developer</h4>
            <p>PT Mediatama Kreasi Informatika | January 2022 - Present</p>
            <p>Kota Bandung, Indonesia</p>
          </div>
        </ScrollAnimation>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.21 * 1000}>
          <img src={FotoDimas} alt="Dimas Mohammad Makdus" />
        </ScrollAnimation>
      </div>
    </Container>
  )
